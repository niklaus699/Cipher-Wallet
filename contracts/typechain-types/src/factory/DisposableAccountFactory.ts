...
export interface DisposableAccountFactoryInterface extends Interface {
...
export interface DisposableAccountFactory extends BaseContract {
  connect(runner?: ContractRunner | null): DisposableAccountFactory;
  waitForDeployment(): Promise<this>;

  interface: DisposableAccountFactoryInterface;
